        ...
        try:
            with DBconnection() as mc_afficher:
                strsql_personnes_avoir_compteur_afficher_data = """SELECT id_compteur, type, DN, 
                                                            GROUP_CONCAT(nom) as PersonneCompteur FROM t_personnes_avoir_compteur
                ...
                if id_film_sel == 0:
                    ...
                    strsql_personnes_avoir_compteur_afficher_data += """ HAVING id_compteur= %(value_id_film_selected)s"""
...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            lst_data_genres_films_non_attribues = [item['nom'] for item in data_genres_films_non_attribues]
